        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="Identificacion" type="number" class="form-control" id="Identificacion" placeholder="Identificacion">@error('Identificacion') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
